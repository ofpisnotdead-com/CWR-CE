...
```shell
pacman -S autoconf-archive automake ccache clang git libtool libxcursor libxinerama libxkbcommon libxrandr libxtst opengl-driver pkgconf vcpkg wayland wayland-protocols
```
...
```shell
dnf install autoconf-archive ccache clang git libGL-devel libtool libtool-ltdl-devel libX11-devel libXcursor-devel libXext-devel libXi-devel libXinerama-devel libxkbcommon-devel libXrandr-devel libXtst pkgconf vcpkg wayland-devel wayland-protocols-devel
```
